  ...
  try
    ...
    begin
      LBAllWord.Items.Strings[I] := StringReplace(LBAllWord.Items.Strings[I],
        '#10#13', sLineBreak, [rfReplaceAll]);

      LBAllWordTranslate.Items.Strings[I] :=
        StringReplace(LBAllWordTranslate.Items.Strings[I], '#10#13', sLineBreak,
        [rfReplaceAll]);
...
procedure TForm1.MemWordKeyPress(Sender: TObject; var Key: Char);
var
  str: string;
  I: Integer;
begin
...
begin
  ...
  try
    ...
    begin
      ...
      Key := StringReplace(Key, sLineBreak, '#10#13', [rfReplaceAll]);

      Value := StringReplace(Value, sLineBreak, '#10#13', [rfReplaceAll]);
      str.Add(Key + '=' + Value);
